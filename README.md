...
# Eden's Notes
Struggleeee with this one, I think I was getting myself confused with all of the pieces... used quite a few references like:
...
* [ISSUES] Complete the `NeedlemanWunsch.align` method found in the align/align.py 
	* Finish the method for filling in the alignment and gap matrices for Needleman-Wunsch.
* [ISSUES] Complete the `NeedlemanWunsch._backtrace` method found in align/align.py
